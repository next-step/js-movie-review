...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   App: () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var _createComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../createComponent */ \"./src/js/createComponent.js\");\n/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Header */ \"./src/js/components/Header.js\");\n/* harmony import */ var _Main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Main */ \"./src/js/components/Main.js\");\n\n\n\n\nasync function App() {\n  const header = await (0,_createComponent__WEBPACK_IMPORTED_MODULE_0__.createComponent)(_Header__WEBPACK_IMPORTED_MODULE_1__.Header);\n  const main = await (0,_createComponent__WEBPACK_IMPORTED_MODULE_0__.createComponent)(_Main__WEBPACK_IMPORTED_MODULE_2__.Main);\n\n  const bindEvents = () => {\n    main.bindEvents();\n  };\n\n  return {\n    element: `\n        ${header.element}\n        ${main.element}\n    `,\n    bindEvents,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/App.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Header: () => (/* binding */ Header)\n/* harmony export */ });\n/* harmony import */ var _images_logo_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../images/logo.png */ \"./src/images/logo.png\");\n\n\nfunction Header() {\n  return {\n    element: /* html */ `\n        <header>\n            <h1><img src=\"${_images_logo_png__WEBPACK_IMPORTED_MODULE_0__}\" alt=\"MovieList 로고\" /></h1>\n            <div class=\"search-box\">\n            <input type=\"text\" placeholder=\"검색\" />\n            <button class=\"search-button\">검색</button>\n            </div>\n        </header>\n  `,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/Header.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Main: () => (/* binding */ Main)\n/* harmony export */ });\n/* harmony import */ var _createComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../createComponent */ \"./src/js/createComponent.js\");\n/* harmony import */ var _MovieList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MovieList */ \"./src/js/components/MovieList.js\");\n\n\n\nasync function Main() {\n  const movieList = await (0,_createComponent__WEBPACK_IMPORTED_MODULE_0__.createComponent)(_MovieList__WEBPACK_IMPORTED_MODULE_1__.MovieList);\n\n  const bindEvents = () => {\n    movieList.bindEvents();\n  };\n\n  return {\n    element: /* html */ `\n        <main>\n            <section class=\"item-view\">\n                <h2>지금 인기 있는 영화</h2>\n                    ${movieList.element}\n            </section>\n        </main>\n    `,\n    bindEvents,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/Main.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Modal: () => (/* binding */ Modal)\n/* harmony export */ });\n/* harmony import */ var _images_star_filled_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../images/star_filled.png */ \"./src/images/star_filled.png\");\n\n\nfunction Modal({ title, score, thumbnailUrl, overview }) {\n  return {\n    element: /* html */ `\n        <div class=\"modal\" style=\"display: none\">\n            <p class=\"item-title\">${title}</p>\n            <p class=\"item-score\">\n                <img src=\"${_images_star_filled_png__WEBPACK_IMPORTED_MODULE_0__}\" alt=\"별점\" /> ${score}\n            </p>\n            <img\n                class=\"item-thumbnail\"\n                src=\"${thumbnailUrl}\"\n                loading=\"lazy\"\n                alt=\"${title}\"\n            />\n            <span>${overview}</span>\n        </div>\n    `,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/Modal.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   MovieCard: () => (/* binding */ MovieCard)\n/* harmony export */ });\n/* harmony import */ var _images_star_filled_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../images/star_filled.png */ \"./src/images/star_filled.png\");\n/* harmony import */ var _createComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../createComponent */ \"./src/js/createComponent.js\");\n/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Modal */ \"./src/js/components/Modal.js\");\n\n\n\n\nasync function MovieCard({\n  index,\n  title,\n  score,\n  thumbnailUrl,\n  overview,\n}) {\n  const modal = await (0,_createComponent__WEBPACK_IMPORTED_MODULE_1__.createComponent)(_Modal__WEBPACK_IMPORTED_MODULE_2__.Modal, {\n    title,\n    score,\n    thumbnailUrl,\n    overview,\n  });\n\n  const bindEvents = () => {\n    const $movieCard = document.querySelector(`[id='${index}']`);\n    const $modal = document.querySelector(`[id='${index}'] > .modal`);\n\n    $movieCard.addEventListener(\"click\", () => {\n      if ($modal.style.display !== \"none\") {\n        $modal.style.display = \"none\";\n      } else {\n        $modal.style.display = \"block\";\n      }\n    });\n  };\n\n  return {\n    element: /* html */ `\n        <li id=${index}>\n            <a href=\"#\">\n                <div class=\"item-card\">\n                    <img\n                        class=\"item-thumbnail\"\n                        src=\"${thumbnailUrl}\"\n                        loading=\"lazy\"\n                        alt=\"${title}\"\n                    />\n                    <p class=\"item-title\">${title}</p>\n                    <p class=\"item-score\">\n                        <img src=\"${_images_star_filled_png__WEBPACK_IMPORTED_MODULE_0__}\" alt=\"별점\" /> ${score}\n                    </p>\n                </div>\n            </a>\n            ${modal.element}\n        </li>\n    `,\n    bindEvents,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/MovieCard.js?");

/***/ }),

/***/ "./src/js/components/MovieList.js":
/*!****************************************!*\
  !*** ./src/js/components/MovieList.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   MovieList: () => (/* binding */ MovieList)\n/* harmony export */ });\n/* harmony import */ var _createComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../createComponent */ \"./src/js/createComponent.js\");\n/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../fetch */ \"./src/js/fetch.js\");\n/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../state */ \"./src/js/state.js\");\n/* harmony import */ var _MovieCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MovieCard */ \"./src/js/components/MovieCard.js\");\n\n\n\n\n\nasync function MovieList() {\n  const [page, setPage] = (0,_state__WEBPACK_IMPORTED_MODULE_2__.useState)(1);\n\n  const movieData = await (0,_fetch__WEBPACK_IMPORTED_MODULE_1__.fetchMovies)({ page });\n\n  const [movies, setMovies] = (0,_state__WEBPACK_IMPORTED_MODULE_2__.useState)([...movieData.results]);\n  const [totalPage] = (0,_state__WEBPACK_IMPORTED_MODULE_2__.useState)(movieData.total_page);\n\n  const movieCards = await Promise.all(\n    movies.map((movie, index) =>\n      (0,_createComponent__WEBPACK_IMPORTED_MODULE_0__.createComponent)(_MovieCard__WEBPACK_IMPORTED_MODULE_3__.MovieCard, {\n        index,\n        title: movie.title,\n        score: movie.vote_average,\n        thumbnailUrl: `https://image.tmdb.org/t/p/w200/${movie.poster_path}`,\n      })\n    )\n  );\n\n  const handleMoreButton = async () => {\n    if (page >= totalPage) {\n      return;\n    }\n\n    await setPage(page + 1);\n\n    const movieData = await (0,_fetch__WEBPACK_IMPORTED_MODULE_1__.fetchMovies)({ page: page + 1 });\n    const newMovies = [...movies, ...movieData.results];\n\n    await setMovies(newMovies);\n  };\n\n  const bindEvents = () => {\n    movieCards.forEach((movieCard) => movieCard.bindEvents());\n\n    const $moreButton = document.querySelector(\"#more-button\");\n\n    $moreButton.addEventListener(\"click\", handleMoreButton);\n  };\n\n  return {\n    element: /* html */ `\n        <ul class=\"item-list\">\n            ${movieCards.map((movieCard) => movieCard.element).join(\"\")}\n        </ul>\n        <button id=\"more-button\" class=\"btn primary full-width\">더 보기</button>\n    `,\n    bindEvents,\n  };\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/components/MovieList.js?");

/***/ }),

/***/ "./src/js/createComponent.js":
/*!***********************************!*\
  !*** ./src/js/createComponent.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createComponent: () => (/* binding */ createComponent),\n/* harmony export */   currentComponent: () => (/* binding */ currentComponent)\n/* harmony export */ });\nlet currentComponent = null;\n\nasync function createComponent(component, props) {\n  const previousComponent = currentComponent;\n\n  currentComponent = { name: component.name, stateIndex: 0 };\n\n  const componentInstance = await component(props);\n\n  currentComponent = previousComponent;\n\n  return componentInstance;\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/createComponent.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   fetchMovies: () => (/* binding */ fetchMovies)\n/* harmony export */ });\nasync function fetchMovies({ page }) {\n  const baseUrl = \"https://api.themoviedb.org/3/movie/popular\";\n  const param = new URLSearchParams({\n    page,\n    language: \"ko-KR\",\n  });\n\n  const response = await fetch(`${baseUrl}?${param}`, {\n    headers: { authorization: `Bearer ${\"eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0YjNjNzY2ZjI1YTUyODBjOTRhYTI0YWFhOTk2NDUwZSIsInN1YiI6IjY2NGUwNDg4OWUxMDRiM2UzZjkwZGVkZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.tKF87SvXwG6xhriio8FvYgRpfbQB2yw1qI-VF23tTO0\"}` },\n  });\n\n  return await response.json();\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/fetch.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   render: () => (/* binding */ render)\n/* harmony export */ });\n/* harmony import */ var _components_App__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/App */ \"./src/js/components/App.js\");\n/* harmony import */ var _createComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createComponent */ \"./src/js/createComponent.js\");\n\n\n\nasync function render() {\n  const $app = document.querySelector(\"#app\");\n\n  const app = await (0,_createComponent__WEBPACK_IMPORTED_MODULE_1__.createComponent)(_components_App__WEBPACK_IMPORTED_MODULE_0__.App);\n\n  $app.innerHTML = app.element;\n  app.bindEvents();\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/js/render.js?");
